...
function solution(candlesNumber, makeNew) {
  let solutions = candlesNumber;
  let leftovers = solutions;
  while (leftovers >= makeNew) {
    const newCandles = (leftovers - (leftovers % makeNew)) / makeNew;
    solutions += newCandles;
